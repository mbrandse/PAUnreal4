...
UPA_CharacterMovementComponent::UPA_CharacterMovementComponent()
{

}

void UPA_CharacterMovementComponent::InitializeComponent()
{
	Super::InitializeComponent();
}

bool UPA_CharacterMovementComponent::IsDucking() const
{
	APiratesAdventureCharacter* Character = Cast<APiratesAdventureCharacter>(CharacterOwner);

	return Character && Character->bIsDucked;
}

void UPA_CharacterMovementComponent::PerformMovement(float DeltaSeconds)
{
...
void UPA_CharacterMovementComponent::Duck()
{
	if (!HasValidData())
	{
		return;
	...
	Character->OnMorganDuck();
}

void UPA_CharacterMovementComponent::UnDuck()
{
	if (!HasValidData())
	{
		return;
...
void UPA_CharacterMovementComponent::Crouch(bool bClientSimulation)
{
	...
	Character->OnMorganCrouch();
}

void UPA_CharacterMovementComponent::UnCrouch(bool bClientSimulation)
{
	static int Tester;
	...
	if (IsDucking())
	{
		...
		FVector RelativeLoc = CharacterOwner->GetMesh()->RelativeLocation;
		RelativeLoc.Z -= ClampedDuckedHalfHeight - CrouchedHalfHeight;
