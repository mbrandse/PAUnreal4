		...
		if(PerformDeepTrace)
		{
			...
			{  
				...
				if(URamaMeleeCore::MeleeSweep(
					...
					{
						RamaMeleeWeapon_OnHit.Broadcast(Hit.GetActor(), Hit.GetComponent(), Hit.ImpactPoint, Hit.ImpactNormal, Hit.BoneName, DamageMapIndex, EachMeleeSweep.ShapeIndex, Hit);
					}
