...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_EightParams(FRamaMeleeHitSignature, class AActor*, HitActor, class UPrimitiveComponent*, HitComponent, const FVector&, ImpactPoint, const FVector&, ImpactNormal, FName, HitBoneName, int32, DamageMapIndex, int32, ShapeIndex, const struct FHitResult&, HitResult);
